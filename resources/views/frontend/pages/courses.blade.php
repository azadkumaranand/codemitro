                    ...
                    <div class="course-item bg-light shadow-sm">
                        <div class="position-relative overflow-hidden">
                            @isset($course->thumbnail)
                                <img class="img-fluid" src="{{Storage::url($course->thumbnail)}}" alt="">
                            @else
                        ...
                        <div class="d-flex justify-content-center border-top">
                                <a href="{{route('coursedetails', ['id'=>base64_encode($course->id)])}}" class="flex-shrink-0 btn btn-sm btn-primary px-3 border-end" style="border-radius: 30px;">Start Learning</a>
                        </div>
                    </div>
                </div>
            @endforeach
