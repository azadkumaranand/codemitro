...
Route::get('/web/tests', [HomeController::class, 'allTests']);
...
Route::get('create-meeting', [GoogleAuthController::class, 'createGoogleMeet'])->name('create-meeting');
Route::get('meeting', [GoogleAuthController::class, 'showMeeting'])->name('show-meeting');
...
Route::middleware(['auth', 'role:teacher'])->group(function(){
    ...
    Route::get('teacher/test/result/{userId}/delete', [TestController::class, 'deleteTestResultOfUser'])->name('test.mcq.result.delete');
